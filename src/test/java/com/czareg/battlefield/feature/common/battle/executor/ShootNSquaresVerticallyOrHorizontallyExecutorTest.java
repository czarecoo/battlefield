...
class ShootNSquaresVerticallyOrHorizontallyExecutorTest {
    ...
    @InjectMocks
    ShootNSquaresVerticallyOrHorizontallyExecutor executor;
    ...
    void shouldReturnExecutionResultSuccessAndDestroyEnemyUnitWhenTargetIsOccupiedByEnemy() {
        ...
        int cooldown = 6666;
        when(cooldownConfig.getShootNSquaresVerticallyOrHorizontallyInMillis()).thenReturn(cooldown);
