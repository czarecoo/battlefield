...
class MoveFromOneToThreeSquaresVerticallyOrHorizontallyGeneratorTest {

    @Mock
    private SpecificCommandFactory specificCommandFactory;

    @InjectMocks
    private MoveFromOneToThreeSquaresVerticallyOrHorizontallyGenerator generator;
    ...
    void shouldGenerateCorrectNumberOfSpecificCommands() {
        ...
        assertEquals(12, specificCommands.size());
    }
}